...
import com.maneeshwar.weatherapp.api.NetworkResponse
import com.maneeshwar.weatherapp.api.WeatherModel
        ...
        Card {
            Column(
                ...
                Row(
                    ...
                    WeatherKeyVal(key = "Participation", value = "${data.current.precipMm} mm")
                }
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.SpaceAround
